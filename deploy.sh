...
kubectl set image deployments/client-deployment client=kstokolos/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=kstokolos/multi-worker:$SHA
